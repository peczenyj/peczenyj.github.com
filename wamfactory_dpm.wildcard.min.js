            ...
            if (typeof window.__tcfapi == 'function') {
              ...
              window.__tcfapi('addEventListener', 2, function(tcData, success){
                if (success && tcData.eventStatus == 'useractioncomplete') {
                  console.log("TCF V2 gdpr:", tcData.gdprApplies,"gdpr_consent:", tcData.tcString);
                  ...
                  window.__tcfapi('removeEventListener', 2, console.log, tcData.listenerId)
                }
              });
            } else if (typeof window.__cmp == 'function'){
                var self = this;
                window.__cmp('getConsentData', null, function (response, success) {
                    console.log("TCF V1 gdpr:", tcData.gdprApplies,"gdpr_consent:", tcData.consentData);
